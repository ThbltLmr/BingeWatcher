...
export default function ShowCard({show}: {show: Show}){
  ...
  return(
    <div className="flex flex-col h-full justify-center align-middle w-full relative">
      <img className="rounded max-w-none h-full object-cover" key={show.tmdbId} src={show.posterUrl.value}></img>
